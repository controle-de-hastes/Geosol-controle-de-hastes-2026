    ...
    <div className="flex items-center justify-end px-6 pt-4 pb-2 sticky top-0 z-40 pointer-events-none">
      <div className="flex items-center gap-3 pointer-events-auto">
        ...
        <div className="relative" ref={filtersRef}>
          ...
          {isFiltersOpen && (
            <div className="absolute right-0 mt-2 w-64 bg-white border border-slate-200 rounded-xl shadow-lg p-4 z-50 flex flex-col gap-4 animate-in fade-in slide-in-from-top-2 max-h-[calc(100vh-120px)] overflow-y-auto">
